package net.tclproject.rpgstamina.command;
...
public class Command extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) {
        ...
        switch (args[0]) {
            ...
            case "add":
                try {
                    int original = player.currentStamina;
                    int value = player.currentStamina + Integer.parseInt(args[2]);
                    if (value > player.getMaxStamina()) value = player.getMaxStamina();
                    if (value < 0) value = 0;
            ...
            case "get":
                sender.addChatMessage(new ChatComponentText(args[1] + " currently has " + player.currentStamina + " stamina."));
                break;
