package net.tclproject.rpgstamina.bauble;
...
public class ItemEnduranceRing extends Item implements IBauble {
    ...
    public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
        if (itemstack.getItemDamage() == 0 && !player.isPotionActive(StEventHandler.endurance)) {
            player.addPotionEffect(new PotionEffect(StEventHandler.endurance.id, 1800, 0, true));
        }
    }
